...
افزودن سخن بزرگان
						...
						<form class="former" method="post" action="quote_add_result.php">
							...
							<div class="col-12 col-md-4 col-lg-4">
								...
								<label for="title">نقل شده از</label>
								<input id="title" class="form-control" type="text" name="writer" >
							</div>
							</div>
							<div style="margin-right: 10px" class="row vazir">
							<div class="col-12 col-md-2 col-lg-3">
								...
								<div class="col-12 col-md-6 col-lg-6">
									<label for="content">متن سخن</label>
									<textarea id="content
" class="form-control" style="height: 200px;"  name="content" ></textarea>
								</div>
							</div>
							<div style="margin-right: 10px" class="row vazir">

...
سخنان بزرگان
								...
								<br>
								<br>
									<form style="display: inline-block;" method="post" action="quote_add.php">
						...
						<div class="row">
							<div class="col-12">';
								...
								$query = 'select id, writer, content from quotes order by id desc';
									...
									<table class="table table-striped table-bordered vazir centerize">
									  <thead>
									    <tr>
									      ...
									      <th class="text-success" scope="col">نویسنده</th>
									      <th scope="col">متن</th>
									...
									foreach ($rows as $row) {
										echo '
											<tr>
												...
												'</td>
												<td>
												<form style="display: inline-block;" method="post" action="quote_update.php">
												<input type="hidden" name="id" value="' . $row['id'] .'">
													<input style="margin-bottom: 5px;" type="submit" class="btn btn-success" value="تغییر">
												</form>
												<form style="display: inline-block;" method="post" action="quote_delete_result.php">
												<input type="hidden" name="id" value="' . $row['id'] .'">

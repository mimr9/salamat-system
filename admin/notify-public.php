...
اعلانات عمومی
								...
								<br>
								<br>
									<form style="display: inline-block;" method="post" action="notify-public_add.php">
						...
						<div class="row">
							<div class="col-12">';
								...
								$query = 'select id, title, content from notify_public order by id desc';
									...
									foreach ($rows as $row) {
										echo '
											<tr>
												...
												'</td>
												<td>
												<form style="display: inline-block;" method="post" action="notify-public_update.php">
												<input type="hidden" name="id" value="' . $row['id'] .'">
													<input style="margin-bottom: 5px;" type="submit" class="btn btn-success" value="تغییر">
												</form>
												<form style="display: inline-block;" method="post" action="notify-public_delete_result.php">
												<input type="hidden" name="id" value="' . $row['id'] .'">
